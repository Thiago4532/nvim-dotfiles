...
local cp_int2ll_tdeb = function()
    api.nvim_buf_set_lines(0, 1, 1, true, {'#define TMM_INT2LL'})
    local lines = api.nvim_buf_get_lines(0, 0, -1, true);
...
map('n', 'mcpp', [[ggdG:-1read ~/CP-Problems/micro1/micro1_base.cpp<CR>G"_dd10k$]])
...
map('n', '<leader>cll', cp_int2ll_tdeb)
